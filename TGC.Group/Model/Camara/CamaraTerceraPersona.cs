...
{
    public class CamaraTerceraPersona : Core.Camara.TgcCamera
    {
        ...
        /// </summary>
        public CamaraTerceraPersona()
        {
            resetValues();
        }

        public CamaraTerceraPersona(Vector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public CamaraTerceraPersona(Vector3 target, Vector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
