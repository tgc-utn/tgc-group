...
namespace TGC.Group.Model
{
    ...
    public class Cam : TgcCamera
    {
        ...
        public Cam(TGCVector3 target, float offsetHeight, float offsetForward) : this()
        {
            Target = target;
        ...
        public Cam(TGCVector3 target, TGCVector3 targetDisplacement, float offsetHeight, float offsetForward)
            : this()
        {
            Target = target;
