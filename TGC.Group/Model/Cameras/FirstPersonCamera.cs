...
namespace TGC.Group.Model.Cameras
{
    public class FirstPersonCamera : TgcCamera
    {
        ...
        public FirstPersonCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        public FirstPersonCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed,
            TgcD3dInput input)
