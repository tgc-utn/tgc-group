...
namespace TGC.Group.Camera
{
    class FpsCamera : TgcCamera
    {
        ...
        public FpsCamera(Vector3 positionEye, TgcD3dInput input) : this(input)
        {
            this.positionEye = positionEye;
        }

        public FpsCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, TgcD3dInput input)
        ...
        public FpsCamera(Vector3 positionEye, float moveSpeed, float jumpSpeed, float rotationSpeed,
            TgcD3dInput input)
